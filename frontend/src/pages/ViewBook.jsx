...
const ViewBook = () => {
    //For handling book show
    const [book, setBook] = useState({});
    //loading state to handle loading time
    ...
    return (
        <div className='p-4'>
            <BackButton />
            <h1 className='text-3x1 my-4'>View Book</h1>
            {loading ? (
                <Spinner />
            ) : (
                <div className='flex flex-col border-2 border-sky-400 rounde-x1 w-fit p-4'>
                    <div className='my-4'>
                    ...
                    <div className='my-4'>
                        <span className='text-x1 mr-4 text-grey-500'>Last Update Time</span>
