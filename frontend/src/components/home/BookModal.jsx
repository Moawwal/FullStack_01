            ...
            >
                ...
                <h2 className='w-fit px-4 py-1 bg-red-300 rounded-lg'>
                        ...
                        <p className='my-2'>
                            ...
                            Amet in commodi atque ullam, minus minima deserunt inventore tempore totam earum exercitationem, facere delectus dignissimos nihil.
                            Aliquam cum assumenda vitae repellendus.
                        </p>
            </div>       
        </div>
    );
